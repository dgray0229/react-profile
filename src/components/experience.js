        ...
        <div className="w-100">
          ...
          <div className="resume-item d-flex flex-column flex-md-row justify-content-between mb-5">
            <div className="resume-content">
              ...
              <div className="subheading mb-3">Devin Gray LLC</div>
            ...
            <div className="resume-date text-md-right">
              <span className="text-primary">September 2019 - November 2019</span>
            </div>
          </div>
          ...
          <div className="resume-item d-flex flex-column flex-md-row justify-content-between mb-5">
            <div className="resume-content">
              ...
              <div className="subheading mb-3">The Home Improvement Guide</div>
          ...
          <div className="resume-item d-flex flex-column flex-md-row justify-content-between mb-5">
            <div className="resume-content">
              <h3 className="mb-0">APS Software Engineer</h3>
          ...
          <div className="resume-item d-flex flex-column flex-md-row justify-content-between mb-5">
            <div className="resume-content">
              ...
              <div className="subheading mb-3">Adler &amp; Associates Entertainment</div>
          ...
          <div className="resume-item d-flex flex-column flex-md-row justify-content-between mb-5">
            <div className="resume-content">
              <h3 className="mb-0">Web Developer</h3>
              <div className="subheading mb-3">Wiredhat Interactive</div>
            ...
            <div className="resume-date text-md-right">
              <span className="text-primary">October 2017 - June 2019</span>
            </div>
          </div>

          <div className="resume-item d-flex flex-column flex-md-row justify-content-between">
            <div className="resume-content">
              <h3 className="mb-0">Tech and Media Arts Instructor</h3>
              <div className="subheading mb-3">New Horizons</div>
            ...
            <div className="resume-date text-md-right">
              <span className="text-primary">June 2017 - October 2017</span>
            </div>
          </div>
          ...
          <div className="resume-item d-flex flex-column flex-md-row justify-content-between">
            <div className="resume-content">
              <h3 className="mb-0">Web Developer</h3>
              <div className="subheading mb-3">Southern California School of Interpretation</div>
            ...
            <div className="resume-date text-md-right">
              <span className="text-primary">January 2017 - March 2017</span>
            </div>
          </div>
          ...
          <div className="resume-item d-flex flex-column flex-md-row justify-content-between">
            <div className="resume-content">
              <h3 className="mb-0">Web Developer</h3>
              <div className="subheading mb-3">Avital Web, Inc</div>
            ...
            <div className="resume-date text-md-right">
              <span className="text-primary">November 2016 - December 2016</span>
            </div>
          </div>

          <div className="resume-item d-flex flex-column flex-md-row justify-content-between">
            <div className="resume-content">
              <h3 className="mb-0">Assistant Instructor</h3>
              <div className="subheading mb-3">UCLA Extension</div>
            ...
            <div className="resume-date text-md-right">
              <span className="text-primary">May 2016 - December 2016</span>
            </div>
          </div>
          ...
          <div className="resume-item d-flex flex-column flex-md-row justify-content-between">
            <div className="resume-content">
              <h3 className="mb-0">Full-Stack Developer</h3>
              <div className="subheading mb-3">Versa Products</div>
          ...
          <div className="resume-item d-flex flex-column flex-md-row justify-content-between">
            <div className="resume-content">
              ...
              <div className="subheading mb-3">Los Angeles Times</div>
          ...
          <div className="resume-item d-flex flex-column flex-md-row justify-content-between">
            <div className="resume-content">
              ...
              <div className="subheading mb-3">Gray Physique</div>
            ...
            <div className="resume-date text-md-right">
              <span className="text-primary">June 2015 - January 2016</span>
            </div>
          </div>
          ...
          <div className="resume-item d-flex flex-column flex-md-row justify-content-between">
            <div className="resume-content">
              <h3 className="mb-0">Personal Trainer</h3>
              <div className="subheading mb-3">Equinox</div>
            ...
            <div className="resume-date text-md-right">
              <span className="text-primary">October 2015 - December 2015</span>
            </div>
          </div>

          <div className="resume-item d-flex flex-column flex-md-row justify-content-between">
            <div className="resume-content">
              <h3 className="mb-0">Web Editor</h3>
              <div className="subheading mb-3">Scrubs AC, Inc.</div>
            ...
            <div className="resume-date text-md-right">
              <span className="text-primary">September 2012 - October 2015</span>
            </div>
          </div>
          ...
          <div className="resume-item d-flex flex-column flex-md-row justify-content-between">
            <div className="resume-content">
              ...
              <div className="subheading mb-3">Karen's Toys</div>
              <p>Work with customers to give them the best possible shopping experience. Manage organizing of the backroom and the front of the store. Maintenance of the store and answering phones. Gift wrapping for birthdays and holidays.</p>

            </div>
            <div className="resume-date text-md-right">
              <span className="text-primary">April 2012 - September 2012</span>
            </div>
          </div>
          ...
          <div className="resume-item d-flex flex-column flex-md-row justify-content-between">
            <div className="resume-content">
              <h3 className="mb-0">Cashier</h3>
              <div className="subheading mb-3">Target</div>
              <p>Handle money and transactions of all forms of payment from credit and debit cards to WIC checks and EBT cards.</p>
            </div>
            <div className="resume-date text-md-right">
              <span className="text-primary">November 2011 - January 2012</span>
            </div>
          </div>
